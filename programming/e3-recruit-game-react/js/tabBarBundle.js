...
/***/ function(module, exports, __webpack_require__) {
			...
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'a',
						{ href: this.props.myHref, 'data-ajax': 'false', 'data-transition': 'fade', 'data-theme': 'a', 'data-icon': this.props.myIcon,
	...
	var TabBar = (function (_React$Component2) {
		...
		_createClass(TabBar, [{
			...
			value: function render() {
				return _react2['default'].createElement(
					'div',
					{ 'data-role': 'tabbar', 'data-iconpos': 'top', 'data-theme': 'a', 'data-cid': 'tabbar3', className: 'codiqa-control ui-footer ui-footer-fixed ui-bar-a ui-navbar ui-mini', role: 'navigation' },
					_react2['default'].createElement(
						'ul',
						{ className: 'ui-grid-b' },
						_react2['default'].createElement(TabBlock, { myHref: '#pre', myIcon: 'arrow-l', liClass: 'ui-block-a', btnText: '上一关', uiIcon: 'ui-icon-arrow-l' }),
						_react2['default'].createElement(TabBlock, { myHref: 'index.html', myIcon: 'home', liClass: 'ui-block-b', btnText: '首页', uiIcon: 'ui-icon-home' }),
						_react2['default'].createElement(TabBlock, { myHref: 'about.html', myIcon: 'grid', liClass: 'ui-block-c', btnText: '爱立信招聘', uiIcon: 'ui-icon-grid' })
					)
				);
			}
		}]);
	...
	_reactDom2['default'].render(_react2['default'].createElement(TabBar, null), document.getElementById('gameTabBar'));
